...
#define LAYOUT_COLOR_BACKGROUND		D3DCOLOR_ARGB(0xff, 112, 112, 112)
#define LAYOUT_COLOR_BORDER			D3DCOLOR_ARGB(0xff, 1, 1, 1)
#define LAYOUT_COLOR_TEXT			D3DCOLOR_ARGB(0xff, 0xff, 0xff, 0xff)
#define LAYOUT_COLOR_SLIDER_BG		D3DCOLOR_ARGB(0xff, 105, 105, 105)
#define LAYOUT_COLOR_SLIDER_BTN		D3DCOLOR_ARGB(0xff, 105, 105, 105)
#define LAYOUT_COLOR_ACTIVE_BG		D3DCOLOR_ARGB(0xff, 169, 169, 169)
